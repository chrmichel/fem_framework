...
int main() {
    fem::core::Mesh1D mesh(std::vector<fem::core::Mesh1D::Point>{fem::core::Mesh1D::Point{0.0}, fem::core::Mesh1D::Point{0.5}, fem::core::Mesh1D::Point{1.0}});

    fem::test::require(mesh.n_nodes() == 3, "mesh.n_nodes() == 3");
    fem::test::require(mesh.n_elements() == 2, "mesh.n_elements() == 2");

    fem::test::require(mesh.node(0)[0] == 0.0, "mesh.node(0) == 0");
    fem::test::require(mesh.node(1)[0] == 0.5, "mesh.node(1) == 0.5");
    fem::test::require(mesh.node(2)[0] == 1.0, "mesh.node(2) == 1");
    ...
    fem::core::Mesh1D mesh2(std::vector<fem::core::Mesh1D::Point>{fem::core::Mesh1D::Point{0.0}, fem::core::Mesh1D::Point{0.25}, fem::core::Mesh1D::Point{0.75}, fem::core::Mesh1D::Point{1.0}}, conn);
    ...
    bool threw = false;
    try {
        fem::core::Mesh1D bad(std::vector<fem::core::Mesh1D::Point>{fem::core::Mesh1D::Point{0.0}, fem::core::Mesh1D::Point{1.0}}, {{0, 5}});
